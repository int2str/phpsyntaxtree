...
// Copyright (c) 2003-2016 Andre Eisenbach <andre@ironcreek.net>
//
...
if ( !isset( $_SESSION['data'] ) )
{
    ...
    $_SESSION['fontsel']   = "free_serif";
    $_SESSION['font']      = "FreeSerif.ttf";
    $_SESSION['fontsize']  = 12;
}

// Render the page

$phrase = $_SESSION['data'];
